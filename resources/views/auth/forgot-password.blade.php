...
<head>
  ...
  <title>IG TRADE | {{__('auth.forgot_password')}}</title>
        ...
        <div class="row mx-0 bg-black-op">
          ...
          <div class="hero-static col-md-6 col-xl-4 d-flex align-items-center invisible" data-toggle="appear"
            ...
            <div class="content content-full">
              ...
              <form class="js-validation-signin px-30" action="{{ route('postForgotPassword') }}" method="post">
                ...
                <div class="form-group" style="text-align:center">
                  ...
                  <button type="submit" class="btn btn-sm btn-hero btn-alt-primary ">
                    <i class="si si-mail mr-10 fa fa-envelope"></i> {{__('auth.send')}}
                  </button>
                </div>
                @csrf
              </form>
